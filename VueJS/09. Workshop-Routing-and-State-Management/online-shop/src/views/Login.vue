...
<article class="card">
  ...
  <form @submit.prevent="onSubmit">
    <div>
      ...
      <input id="username" v-model="user.username" required type="text" :disabled="isLoading">
    </div>
    <div>
      <label for="password">Password</label>
      <input v-model="user.password" required="password" type="password" :disabled="isLoading">
    </div>
